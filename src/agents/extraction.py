...
class ExtractionAgent:
    ...
    def _build_messages(self, text: str, use_few_shot: bool = True) -> list[ChatMessage]:
        ...
        if use_few_shot:
            for example in get_few_shot_examples():
                role = MessageRole.USER if example["role"] == "user" else MessageRole.ASSISTANT
...
Extrahierter Knowledge Graph (JSON):"""
    ...
    def _parse_llm_response(self, response_text: str, source_text: str) -> KnowledgeGraphExtraction:
        """
